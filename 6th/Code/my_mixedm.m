function [sys,x0,str,ts] = my_mixedm(t,x,u,flag)
%MIXEDM An example integrator followed by unit delay MATLAB file S-function 
%   Example MATLAB file S-function implementing a hybrid system consisting
