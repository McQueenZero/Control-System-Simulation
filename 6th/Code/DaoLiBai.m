...
sys = [ x(2);
        1/(M*cos(x(3)))*((u+m*l*x(4)^2*sin(x(3)))*cos(x(3))-(9.8*sin(x(3))+l*(x(4))^2*sin(x(3))*cos(x(3)))*m);
        x(4);
        1/(M*l*cos(x(3))^2)*((M+m)*(9.8*sin(x(3))+l*x(4)^2*sin(x(3))*cos(x(3)))-cos(x(3))*(u+m*l*sin(x(3)))) ];
